	...
	<div class="w3-main w3-container" style="margin-left:270px;margin-top:130px;">
		...
		<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
			...
			<div class="w3-code cssHigh notranslate">
				...
				$sql = "INSERT INTO livros (titulo, autor, numero_paginas, isbn, id_genero) VALUES ('$titulo','$autor','$numeroPags', '$ISBN', '$genero')";
				
				?>
				<div class='w3-responsive w3-card-4'>
					<div class="w3-container w3-theme">
						<h2>Inclusão de Novo Livro</h2>
					</div>
					<?php
